...
import com.pangtaek.chatplatform.common.constant.Constants;
...
public class JWTProvider {
    ...
    public static String createToken(String name) {
        return JWT.create()
                ...
                .withExpiresAt(
                        new Date(System.currentTimeMillis() + tokenTimeForMinute * Constants.ON_MINUTE_TO_MILLIS))
    ...
    public static DecodedJWT checkTokenForRefresh(String token) {
        try {
            ...
            throw new CustomException(ErrorCode.TOEKN_IS_INVALID);
